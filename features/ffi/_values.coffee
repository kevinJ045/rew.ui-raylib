...
func_map = class {
	...
	ffi_type(rew::ffi::buffer) BeginTextureMode = -> rew::ffi::buffer
	...
	ffi_type(rew::ffi::ptr,rew::ffi::i32,rew::ffi::buffer) SetShaderValueTextureWrapper = -> rew::ffi::buffer
	...
	ffi_type(rew::ffi::ptr,rew::ffi::buffer,rew::ffi::ptr,rew::ffi::f32,rew::ffi::i64) DrawBillboardWrapper = -> rew::ffi::buffer
	ffi_type(rew::ffi::ptr,rew::ffi::buffer,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::i64) DrawBillboardRecWrapper = -> rew::ffi::buffer
	ffi_type(rew::ffi::ptr,rew::ffi::buffer,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::f32,rew::ffi::i64) DrawBillboardProWrapper = -> rew::ffi::buffer
	...
	ffi_type(rew::ffi::buffer,rew::ffi::i32,rew::ffi::buffer) SetMaterialTexture = -> rew::ffi::buffer
	...
	ffi_type(rew::ffi::buffer,rew::ffi::ptr) SetShapesTextureWrapper = -> rew::ffi::buffer
	ffi_type() GetShapesTexture = -> rew::ffi::buffer
	...
	ffi_type(rew::ffi::buffer) LoadImageFromTextureWrapper = -> rew::ffi::ptr
	...
	ffi_type(rew::ffi::buffer) LoadTexture = -> rew::ffi::buffer
	ffi_type(rew::ffi::ptr) LoadTextureFromImageWrapper = -> rew::ffi::buffer
	ffi_type(rew::ffi::ptr,rew::ffi::i32) LoadTextureCubemapWrapper = -> rew::ffi::buffer
	ffi_type(rew::ffi::i32,rew::ffi::i32) LoadRenderTexture = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer) IsTextureValid = -> rew::ffi::bool
	ffi_type(rew::ffi::buffer) UnloadTexture = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer) IsRenderTextureValid = -> rew::ffi::bool
	ffi_type(rew::ffi::buffer) UnloadRenderTexture = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::buffer) UpdateTexture = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::ptr,rew::ffi::buffer) UpdateTextureRecWrapper = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer) GenTextureMipmaps = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::i32) SetTextureFilter = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::i32) SetTextureWrap = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::i32,rew::ffi::i32,rew::ffi::i64) DrawTexture = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::ptr,rew::ffi::i64) DrawTextureVWrapper = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::ptr,rew::ffi::f32,rew::ffi::f32,rew::ffi::i64) DrawTextureExWrapper = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::i64) DrawTextureRecWrapper = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::f32,rew::ffi::i64) DrawTextureProWrapper = -> rew::ffi::buffer
	ffi_type(rew::ffi::buffer,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::ptr,rew::ffi::f32,rew::ffi::i64) DrawTextureNPatchWrapper = -> rew::ffi::buffer
