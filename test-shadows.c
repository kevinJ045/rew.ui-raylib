...
int main(void)
{
    ...
    Shader shadowShader = LoadShader(TextFormat("assets/shadow.vs", GLSL_VERSION),
                                     TextFormat("assets/shadow.fs", GLSL_VERSION));
    ...
    Model robot = LoadModelFromMesh(GenMeshCube(1.0f, 1.0f, 1.0f));
	robot.materials[0].shader = shadowShader;
