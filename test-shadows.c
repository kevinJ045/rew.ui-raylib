...
int main()
{
    ...
    Model car = LoadModel(".artifacts/old_car_new.glb");
    ...
    car.materials[0].maps[MATERIAL_MAP_ALBEDO].texture = LoadTexture(".artifacts/old_car_d.png");
    car.materials[0].maps[MATERIAL_MAP_METALNESS].texture = LoadTexture(".artifacts/old_car_mra.png");
    car.materials[0].maps[MATERIAL_MAP_NORMAL].texture = LoadTexture(".artifacts/old_car_n.png");
    car.materials[0].maps[MATERIAL_MAP_EMISSION].texture = LoadTexture(".artifacts/old_car_e.png");

    // Load floor model mesh and assign material parameters
    // NOTE: A basic plane shape can be generated instead of being loaded from a model file
    Model floor = LoadModel(".artifacts/plane.glb");
    ...
    floor.materials[0].maps[MATERIAL_MAP_ALBEDO].texture = LoadTexture(".artifacts/road_a.png");
    floor.materials[0].maps[MATERIAL_MAP_METALNESS].texture = LoadTexture(".artifacts/road_mra.png");
    floor.materials[0].maps[MATERIAL_MAP_NORMAL].texture = LoadTexture(".artifacts/road_n.png");
